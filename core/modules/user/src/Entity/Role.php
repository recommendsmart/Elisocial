...
class Role extends ConfigEntityBase implements RoleInterface {
  ...
  public function calculateDependencies() {
    ...
    if (!empty($invalid_permissions)) {
      @trigger_error('Adding non-existent permissions to a role is deprecated in drupal:9.3.0 and will trigger a runtime exception. The incorrect permissions are "' . implode('", "', $invalid_permissions) . '". Permissions should be defined in a permissions.yml file or a permission callback. See https://www.drupal.org/project/social/issues/3397494.', E_USER_DEPRECATED);
